    ...
    $.fn.ace_colorpicker = function (options) {
        ...
        this.each(function () {
            ...
            $(this).hide().find('option').each(function () {
                ...
                colors += '<li><a class="' + $class + '" style="background-color:' + this.value + ';" data-color="' + this.value.replace("? string:","").replace(" ?","") + '"></a></li>';
            }).end().on('change.ace_inner_call', function () {
                if (this.value == "? undefined:undefined ?") {
                    $(this).next().find('.btn-colorpicker').css('background-color', "#FFFFFF");
                } else {
                    $(this).next().find('.btn-colorpicker').css('background-color', this.value.replace("? string:", "").replace(" ?", ""));
                }
                
            })
			.after('<div class="dropdown dropdown-colorpicker"><a data-toggle="dropdown" class="dropdown-toggle" ><span class="btn-colorpicker" style="background-color:' + color + '"></span></a><ul class="dropdown-menu' + (settings.caret ? ' dropdown-caret' : '') + (settings.pull_right ? ' pull-right' : '') + '">' + colors + '</ul></div>')
